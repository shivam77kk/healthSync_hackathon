...
export default function LoginForm({ role, onSuccess, onError }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 rounded-xl py-3 px-4 transition-all duration-200 hover:shadow-md disabled:opacity-50"
      >
