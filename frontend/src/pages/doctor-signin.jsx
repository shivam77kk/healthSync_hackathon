...
export default function DoctorSignin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await login(formData.email, formData.password, 'doctor');
          ...
          <div className="w-full max-w-md">
            <div className="bg-purple-800/40 backdrop-blur-sm border border-purple-600/30 rounded-2xl p-8">
              ...
              <div className="flex bg-purple-700/30 rounded-lg p-1 mb-6">
                <button className="flex-1 py-2 px-4 rounded-md text-sm font-medium bg-purple-600 text-white">
                  Sign In
                </button>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-purple-700/30 hover:bg-purple-600/30 border border-purple-600/30 text-purple-200 py-3 px-6 rounded-lg font-medium transition-all duration-200 flex items-center justify-center gap-3"
                >
